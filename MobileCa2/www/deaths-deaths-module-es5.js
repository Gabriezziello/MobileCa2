    ...
    var DeathsPage = /*#__PURE__*/function () {
      ...
      _createClass(DeathsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.api.getTotalDeaths(null).subscribe(function (res) {
            //  console.log(res[0]);
            _this.totalDeaths = res[0];
          });
        }
      }, {
        key: "getDeaths",
        value: function getDeaths(event) {
          var _this2 = this;

          var search = event.target.value;
          this.api.getTotalDeaths(search).subscribe(function (res) {
            // console.log(res[0]);
            _this2.totalDeaths = res[0];
          });
        }
      }]);
