  ...
  function srcAppPagesCharactersCharactersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharactersPage = /*#__PURE__*/function () {
      ...
      _createClass(CharactersPage, [{
        ...
        key: "getCharacters",
        value: function getCharacters(isFirstLoad, event) {
          var _this = this;

          this.api.getCharacters(this.page_limit, this.page_limit * this.page_number).subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
              _this.characters.push(data[i]);
            }
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])], CharactersPage);
    /***/
  }
}]);
