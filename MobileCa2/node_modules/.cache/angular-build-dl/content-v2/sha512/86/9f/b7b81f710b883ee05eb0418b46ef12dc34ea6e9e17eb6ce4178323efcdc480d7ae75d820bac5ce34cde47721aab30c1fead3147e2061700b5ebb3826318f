  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "getQuotesByAuthor",
        value: function getQuotesByAuthor(author) {
        ...
        value: function getCharacters(limit, offset) {
          return this.http.get("https://www.breakingbadapi.com/api/characters?limit=".concat(limit, "&offset=").concat(offset));
        }
      }, {
        key: "getEpisode",
        ...
        key: "getTotalDeaths",
        value: function getTotalDeaths(search) {
          if (search && search.trim() != "") {
            return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(search));
          }
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        key: "isFavourite",
        value: function isFavourite(Id, key) {
        ...
        key: "favourite",
        value: function favourite(Id, key) {
          var _this = this;
          ...
          return this.storage.get(key).then(function (result) {
            if (result) {
              ...
              return _this.storage.set(key, [Id]);
            }
          });
        }
      }, {
        key: "unfavourite",
        value: function unfavourite(Id, key) {
          var _this2 = this;
          ...
          return this.storage.get(key).then(function (result) {
            if (result) {
              ...
              return _this2.storage.set(key, result);
            }
          });
        }
      }]);
    ...
    FavouriteService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], FavouriteService);
    /***/
  }
}]);
